...
:::{#exm-a=1}
Betragt andengradspolynomiet med forskrift
...
Vi skal nu have trænet perceptronen. Perceptronen[^2] gør dybest set det, at den prøver at bestemme en ret linje, som kan bruges til at adskille de røde punkter fra de blå punkter i punktplottet ovenfor. En ret linje i et 2-dimensionalt koordinatsystem har helt generelt en ligning på formen
